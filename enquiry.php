...
<body>
  ...
  <div class="sidebar">
    <div class="logo-details">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeASUvdF909L11DcwxeG-GkBILLwPtBo-PtQ&s" height="50" width="50" style="margin-right: 10px; margin-left: 10px" />
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="update-admission.php" class="active">
          <i class='bx bx-grid-alt' ></i>
          <span class="links_name">Update Admission</span>
        </a> 
      </li>
    </ul>
  </div>
        ...
        <form action="enquiry-backend.php" method="post" class="form">
          ...
          <div class="column">
            ...
            <div class="input-box">
                ...
                <input type="number" id="StudentMobileNo" name="StudentMobileNo" placeholder="Enter phone number" required oninput="validatestudentPhoneNumber(this)" />
                <div id="avail"></div>
          ...
          <div class="column">
            <div class="input-box">
              <label><b>Student's Email Address <span style="color: red;">*</span></b></label>
              <input type="text" id="StudentEmailId" name="StudentEmailId" placeholder="Enter email address"  required/>
            </div>

            <div class="input-box">
              <label><b>EMIS Number <span style="color: red;">*</span></b></label>
          ...
          <div class="column">
            ...
            <!-- Father occupation -->
            <div class="input-box">
              <label><b>Father's Occupation <span style="color: red;">*</span></b></label>
              <div class="select-box">
          ...
          <div class="column">
            ...
            <!-- Religion -->
            <div class="input-box">
              <label><b>Religion <span style="color: red;">*</span> </b></label>
              <div class="select-box">
          ...
          <div class="column">
            ...
            <!-- pincode -->
            <div class="input-box">
              <label><b>PinCode <span style="color: red;">*</span></b></label>
              <input id="Pincode" type="number" name="Pincode" maxlength="6" placeholder="Enter the pincode" required>
            </div>
            <!-- village -->
            <div class="input-box">
              <label><b>Village <span style="color: red;">*</span></b></label>
          ...
          <div class="column">
            <!-- Seeking Admission -->
            <div class="input-box">
              <label for="SeekingAdmission"><b>Seeking Admission For : <span style="color: red;">*</span></b></label>
              <div class="select-box">
            ...
            <!-- Approached by -->
            <div class="input-box">
              <label for="Source"><b>How you know about the college?</b></label>
              <div class="select-box">
          ...
          <div id="ugFields" style="display: none;">
            ...
            <div class="column">
              ...
              <!-- TotalMarks in 10th -->
              <div class="input-box">
                <label for="tm10"><b>Total Marks(in 10th Std) </b></label>
            ...
            <div class="column">
              ...
              <div class="input-box">
                <label for="registerNo"><b>12th Register Number </b></label>
              ...
              <div class="input-box">
                <label for="co"><b>Cut Off(in 12th Std) </b></label>
            ...
            <div class="column">
              ...
              <div class="input-box">
                <label for="ugchoice1"><b>Choice 1 </b></label>
              ...
              <div class="input-box">
                <label for="ugchoice2"><b>Choice 2 </b></label>
                <div class="select-box">
          ...
          <div id="leFields" style="display: none;">
            ...
            <div class="column">
              ...
              <div class="input-box">
                <label for="dipmark"><b>Percentage Scored in Diploma </b></label>
          ...
          <div id="pgFields" style="display: none;">
            ...
            <div class="input-box">
              <label><b>Bachelor's Degree : </b></label>
            </div>
            ...
            <div class="column">              
              ...
              <div class="input-box">
                <label for="cgpa"><b> CGPA or Percentage </b></label>
