...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeASUvdF909L11DcwxeG-GkBILLwPtBo-PtQ&s" height="40" width="40" style="margin-left: 10px; margin-right: 10px;" alt="" />
                </i>
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="update-admission.php" class="active">
                        <i class='bx bx-grid-alt'>
                        </i>
                        <span class="links_name">
                            Update Admission
                        ...
                        <form action="admission-backend.php" method="post" class="form">
                            ...
                            <div class="column">
                                <div class="input-box">
                                    <label>
                                        <b>
                                            Student's Email Address <span style="color: red;">*</span>
                                        </b>
                                    </label>
                                ...
                                <div class="input-box">
                                    <label>
                                        <b>
                                            EMIS Number <span style="color: red;">*</span>
                                        </b>
                                    </label>
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="select-box">
                                        <select id="salute" name="Salutation" required>
                                            <option hidden>
                                                Selvan / Selvi
                                            </option>
                                            <option>
                            ...
                            <div class="column">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" id="BloodGroup" name="BloodGroup" placeholder="Enter BloodGroup" required
                                    />
                                    <!-- <div class="select-box">
                            ...
                            <div class="column">
                                <!-- Aadhar Number Input -->
                                <div class="input-box">
                                    <label><b>Aadhar Number <span style="color: red;">*</span></b></label>
                                    <input type="number" id="AadhaarNumber" name="AadhaarNumber" placeholder="Enter Aadhar number" required/>
                                </div>
                            ...
                            <div class="column" style="margin-top: 10px;">
                                <!-- Seeking Admission -->
                                <div class="input-box">
                                    <label for="educationLevel"><b>Seeking Admission For : <span style="color: red;">*</span></b></label>
                                    <div class="select-box">
                                        <select name="SeekingAdmissionFor" id="educationLevel" required>
                                            <option value="">-- Select --</option>
                            ...
                            <div id="ugFields" style="display: none;">
                                ...
                                <div class="column">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="number" name="UGTotalMark10" id="ugtm10" min="0" max="500" placeholder="Enter total Marks" />
                                        <span id="totalMarkError" style="color: red; display: none;">Total marks cannot exceed 500.</span>
                                    </div>

                                    <script>
                                        const totalMarkInput = document.getElementById("ugtm10");
                                        const totalMarkError = document.getElementById("totalMarkError");

                                        totalMarkInput.addEventListener("input", function () {
                                            const value = parseInt(totalMarkInput.value);

                                            if (value > 500 || value < 0) {
                                                totalMarkError.style.display = "block";
                                                totalMarkInput.style.border = "1px solid red"; // Optional: Highlight the input box in red
                                            } else {
                                                totalMarkError.style.display = "none";
                                                totalMarkInput.style.border = ""; // Reset input box styling
                                            }
                                        });
                                    </script>
                                ...
                                <!-- Mathematics Mark -->
                                    <div class="input-box">
                                        ...
                                        <span id="mathsError" style="color: red; display: none;">Mathematics mark must be between 0 and 100.</span>
                                    </div>
                                    ...
                                    <div class="input-box">
                                        ...
                                        <span id="physicsError" style="color: red; display: none;">Physics mark must be between 0 and 100.</span>
                                    </div>
                                    ...
                                    <div class="input-box">
                                        ...
                                        <span id="chemistryError" style="color: red; display: none;">Chemistry mark must be between 0 and 100.</span>
                                    </div>
                                    ...
                                    <script>
                                        ...
                                        const mathsMarkInput = document.getElementById("maths");
                                        const mathsError = document.getElementById("mathsError");

                                        const physicsMarkInput = document.getElementById("phy");
                                        const physicsError = document.getElementById("physicsError");

                                        const chemistryMarkInput = document.getElementById("che");
                                        const chemistryError = document.getElementById("chemistryError");

                                        // Apply validation to each field
                                        validateInput(mathsMarkInput, mathsError, 0, 100);
                                        validateInput(physicsMarkInput, physicsError, 0, 100);
                                        validateInput(chemistryMarkInput, chemistryError, 0, 100);
                                    </script>
                                ...
                                <div class="column">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="number" id="registerNo" name="RegistrationNumber" placeholder="Enter register number"  />
                                    </div>

                                    <div class="input-box">
                                        <label for="tm12"><b>Total Marks (in 12th Std) <span style="color: red;">*</span></b></label>
                                        <input type="number" id="ugtm12" name="UGTotalMark12" min="0" max="600" placeholder="Enter total Marks" />
                                        <span id="totalMark12Error" style="color: red; display: none;">Total marks cannot exceed 600.</span>
                                    </div>

                                    <script>
                                        const totalMark12Input = document.getElementById("ugtm12");
                                        const totalMark12Error = document.getElementById("totalMark12Error");

                                        totalMark12Input.addEventListener("input", function () {
                                            const value = parseInt(totalMark12Input.value);

                                            if (value > 600 || value < 0) {
                                                totalMark12Error.style.display = "block";
                                                totalMark12Input.style.border = "1px solid red"; // Highlight the input box with red border
                                            } else {
                                                totalMark12Error.style.display = "none";
                                                totalMark12Input.style.border = ""; // Reset input box styling
                                            }
                                        });
                                    </script>
                                    ...
                                    <!-- <div class="input-box">
                                        ...
                                        <input type="number" step="any" id="cgpa" name="CutOff" min="0" max="200.0"placeholder="Enter your Cutoff"  />
                                    </div> -->

                                    <div class="input-box">
                                    <label for="cgpa"><b> CUT OFF <span style="color: red;">*</span></b></label>
                                    <input type="number" step="any" id="cgpa" name="CutOff" min="0" max="200.0"placeholder="Enter your percentage"  />
                                </div>
                            ...
                            <div id="leFields" style="display: none;">
                                ...
                                <div class="input-box">
                                    <label for="tm10"><b>Total Marks (in 10th Std) <span style="color: red;">*</span></b></label>
                                    <input type="number" id="letm10" name="LETotalMark10" min="0" max="500" placeholder="Enter total Marks" />
                                    <span id="lateraltotalMark10Error" style="color: red; display: none;">Total marks cannot exceed 500.</span>
                                </div>

                                <script>
                                    const lateraltotalMark10Input = document.getElementById("letm10");
                                    const lateraltotalMark10Error = document.getElementById("lateraltotalMark10Error");

                                    lateraltotalMark10Input.addEventListener("input", function () {
                                        const value = parseInt(lateraltotalMark10Input.value);

                                        // Check if the input is empty or out of the valid range
                                        if (isNaN(value) || value < 0 || value > 500) {
                                            lateraltotalMark10Error.style.display = "block"; // Show the error message
                                            lateraltotalMark10Input.style.border = "1px solid red"; // Highlight the input box in red
                                        } else {
                                            lateraltotalMark10Error.style.display = "none"; // Hide the error message
                                            lateraltotalMark10Input.style.border = ""; // Reset input box styling
                                        }
                                    });
                                </script>
                                ...
                                <div class="input-box">
                                    <label for="tm12"><b>Total Marks (in 12th Std) <span style="color: red;">*</span></b></label>
                                    <input type="number" id="letm12" name="LETotalMark12" min="0" max="600" placeholder="Enter total Marks" />
                                    <span id="lateraltotalMark12Error" style="color: red; display: none;">Total marks cannot exceed 600.</span>
                                </div>

                                <script>
                                    const lateraltotalMarkl12Input = document.getElementById("letm12");
                                    const lateraltotalMark12Error = document.getElementById("lateraltotalMark12Error");

                                    lateraltotalMarkl12Input.addEventListener("input", function () {
                                        const value = parseInt(lateraltotalMarkl12Input.value);

                                        if (value > 600 || value < 0) {
                                            lateraltotalMark12Error.style.display = "block"; // Show the error message
                                            lateraltotalMarkl12Input.style.border = "1px solid red"; // Highlight the input box in red
                                        } else {
                                            lateraltotalMark12Error.style.display = "none"; // Hide the error message
                                            lateraltotalMarkl12Input.style.border = ""; // Reset input box styling
                                        }
                                    });
                                </script>
                            ...
                            <div id="pgFields" style="display: none;">
                                ...
                                <div class="input-box">
                                    <label for="tm10"><b>Total Marks (in 10th Std) <span style="color: red;">*</span></b></label>
                                    <input type="number" id="pgtm10" name="PGTotalMark10" min="0" max="500" placeholder="Enter total Marks" />
                                    <span id="totalMarkPG10Error" style="color: red; display: none;">Total marks cannot exceed 500.</span>
                                </div>

                                <script>
                                    const totalMarkPG10Input = document.getElementById("pgtm10");
                                    const totalMarkPG10Error = document.getElementById("totalMarkPG10Error");

                                    totalMarkPG10Input.addEventListener("input", function () {
                                        const value = parseInt(totalMarkPG10Input.value);

                                        if (value > 500 || value < 0) {
                                            totalMarkPG10Error.style.display = "block";
                                            totalMarkPG10Input.style.border = "1px solid red"; // Highlight input box in red
                                        } else {
                                            totalMarkPG10Error.style.display = "none";
                                            totalMarkPG10Input.style.border = ""; // Reset input box styling
                                        }
                                    });
                                </script>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="number" id="pgtm12" name="PGTotalMark12" min="0" max="600" placeholder="Enter total Marks" />
                                    <span id="totalMarkPG12Error" style="color: red; display: none;">Total marks cannot exceed 600.</span>
                                </div>

                                <script>
                                    const totalMarkPG12Input = document.getElementById("pgtm12");
                                    const totalMarkPG12Error = document.getElementById("totalMarkPG12Error");

                                    totalMarkPG12Input.addEventListener("input", function () {
                                        const value = parseInt(totalMarkPG12Input.value);

                                        if (value > 600 || value < 0) {
                                            totalMarkPG12Error.style.display = "block";
                                            totalMarkPG12Input.style.border = "1px solid red"; // Highlight input box in red
                                        } else {
                                            totalMarkPG12Error.style.display = "none";
                                            totalMarkPG12Input.style.border = ""; // Reset input box styling
                                        }
                                    });
                                </script>
...
<div class="input-box">
                            ...
                            <div class="column">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="number" id="AnnualFamilyIncome" name="AnnualFamilyIncome" placeholder="Enter Annual Family Income" required
                                    />
                                </div>
                            ...
                            <div class="column" style="margin-top: 10px;">
                                <div class="input-box">
                                    ...
                                    <input id="P_Country" type="text" name="P_Country" placeholder="Enter Country" oninput="toUpperCase(this)" required>
                                </div>
                            ...
                            <div class="column">
                                <div class="input-box">
                                    ...
                                    <div class="select-box">
                                        <select id="P_LocationType" name="P_LocationType" required>
                                            <option hidden>
                                                --select--
                                            </option>
                                            <option>
                                ...
                                <div class="input-box">
                                    <label>
                                        <b>
                                        Village/Area Name <span style="color: red;">*</span>
                                        </b>
                                    </label>
                                    <input id="P_Village" type="text" name="P_Village" placeholder="Enter Your Village" required>
                                </div>                            
                            </div>
                            <div class="column">
                                <div class="input-box">
                                    ...
                                    <input id="P_Block" type="text" name="P_Block" placeholder="Enter Block" required>
                                </div>
                                <div class="input-box">
                                    <label>
                                        <b>
                                    ...
                                    <input id="P_Pincode" type="number" name="P_Pincode" placeholder="Enter Pincode" required>
                                </div>
                                <div class="input-box">
                                    <label>
                                        <b>
                                        Village Panchayat/Corporation/Municipality/Town Panchayat <span style="color: red;">*</span>
                                        </b>
                                    </label>
                                    <input id="P_VillagePanchayat" type="text" name="P_VillagePanchayat" placeholder="Enter Village Panchayat" required>
                                </div>
                            </div>                         
                            ...
                            <div class="column">
                                <div class="input-box">
                                    ...
                                    <input id="P_PostalAddress" type="text" name="P_PostalAddress" placeholder="Enter Address" required>
                                </div>
                            </div>                  
                            ...
                            <div class="column">
                                ...
                                <div class="input-box">
                                    <label>
                                        <b>
                                            Village Panchayat/Corporation/Municipality/Town Panchayat
                                        </b>
                                    </label>
