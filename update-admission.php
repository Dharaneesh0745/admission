...
<html lang="en" dir="ltr">
                        ...
                        <form action="update-admission-backend.php" method="post" class="form">
                            ...
                            <div class="column">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" id="Community" name="Community" placeholder="Enter Community name""
                                    />
                                    <!-- <div class="select-box">
                            ...
                            <div id="ugFields" style="display: none;">
                                ...
                                <div class="column">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="text" id="registerNo" name="RegisterNo12" placeholder="Enter register number"  />
                                    </div>
    ...
    <input type="number" id="co" name="CutOff" min="0" max="200" step="0.01" placeholder="Enter your Cutoff" />
</div>
